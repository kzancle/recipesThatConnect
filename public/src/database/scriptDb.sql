...
fkusuario INT,
CONSTRAINT chTipo CHECK (tipo IN ('entrada', 'prato principal', 'sobremesa', 'bebida', 'outro')),
CONSTRAINT chOcasiao CHECK (tipo IN ('data comemorativa', 'dia a dia', 'evento', 'presente', 'outro')),
